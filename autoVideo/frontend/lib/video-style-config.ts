...
export const VIDEO_MODEL_SELECTION_HINTS: Record<string, string> = {
  ...
  wan: '阿里云 wan2.6-i2v-flash，动漫叙事首选，角色连贯性好，可选原生音频',
...
export const VIDEO_MODEL_OPTIONS_VT: VideoModelCapability[] = [
  ...
  },
  {
    ...
    icon: '🎬',
    desc: '二维动漫叙事首选，角色连贯性好 · 图生视频 · 可选原生音频',
    provider: '阿里云 DashScope · Wan 2.6 Flash',
    audioSupport: 'native',
    aspectRatio: 'unsupported',
    resolution: 'unsupported',
    multiVariant: 'unsupported',
    clipDuration: '当前接入固定单段约 5 秒',
    note: '默认无声；可在视频页选择「原生音频」开启模型自带环境音。当前接入未开放宽高比、分辨率与多候选配置。',
    tags: ['动漫', '叙事稳定', '角色连贯'],
    speed: 'medium',
    quality: 'standard',
    bestFor: ['anime-2d'],
