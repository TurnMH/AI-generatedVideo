...
export const CREATE_PAGE_DISPLAY: Record<ProjectMediaKind, CreatePageDisplayConfig> = {
  ...
  ad: {
    stepLabels: ['广告信息', '模型与生成能力', '脚本与广告配置'],
    stepDescriptions: ['明确广告目标与创意方向', '选择文案、图片、视频与配音模型', '确认投放脚本、分镜和成片参数'],
    flowHint: '广告信息、模型、分镜配置',
    afterCreateTitle: '进入广告项目',
    afterCreateHint: '继续推进广告脚本、分镜、素材、配音与成片生成',
    titlePlaceholder: '例如：品牌夏季新品短视频广告',
    descriptionPlaceholder: '描述广告目标、受众、卖点和风格，例如新品上市、快节奏、适合信息流投放。',
    targetEpisodesLabel: '目标广告分段数',
    targetEpisodesHint: '用于后续拆分广告脚本段落、分镜和视频片段估算。',
    scriptLabel: '上传广告脚本（可选）',
    scriptUploadTitle: '点击上传广告文案或脚本文件',
    scriptUploadHint: '支持 .txt、.md、.docx 格式',
    storyboardSectionTitle: '广告分镜默认设置',
    consistencyLabel: '品牌与视觉一致性',
    consistencyHint: '数值越高越强调品牌主体、产品和场景的一致视觉表现。',
    styleTagHint: '建议优先标注广告类型、受众和画面气质，便于后续脚本、分镜与视频风格统一。',
    showPresetTemplates: true,
    showTargetEpisodes: true,
    showVideoMode: true,
    showVideoStyle: true,
