...
export const CREATE_PAGE_DISPLAY: Record<ProjectMediaKind, CreatePageDisplayConfig> = {
  video: {
    stepLabels: ['写什么内容', '确认并创建'],
    stepDescriptions: ['选类型、起名、上传剧本', '确认画面和配音设置'],
    flowHint: '2 步完成',
    afterCreateTitle: '开始制作',
    afterCreateHint: '上传剧本后会自动帮你分集和拆分镜头',
    titlePlaceholder: '例如：西游记剧情解说',
    descriptionPlaceholder: '简单写一句想做什么（选填）',
    targetEpisodesLabel: '打算做几集',
    scriptLabel: '上传剧本或解说稿',
    scriptUploadTitle: '点击上传文件',
    scriptUploadHint: '支持 txt、md、docx，有章节标记会优先按章节分集',
    storyboardSectionTitle: '画面设置',
    consistencyLabel: '角色长相稳定度',
    consistencyHint: '越高越像同一个人，越低画面变化更自由。',
    styleTagHint: '不用手动选标签，选题材风格后会自动带上。',
