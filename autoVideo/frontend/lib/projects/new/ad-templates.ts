...
export const AD_CAMPAIGN_TEMPLATES: AdCampaignTemplate[] = [
  {
    ...
    label: '强钩子转化广告',
    desc: '适合信息流投放、前三秒抓人、卖点压缩和立即转化。',
    tags: ['信息流', '转化', '快节奏'],
    campaignType: 'performance',
    objective: 'conversion',
    targetAudience: '高意向新客 / 即将下单用户',
    cta: '立即下单',
    durationPreference: '15s',
    styleTags: ['广告', '信息流', '转化导向', '快节奏', '强钩子'],
  ...
  },
  {
    key: 'ad-brand-film',
    label: '品牌质感广告',
    desc: '适合品牌升级、主视觉大片和高质感调性输出。',
    tags: ['品牌', '质感', '主视觉'],
    campaignType: 'brand',
    objective: 'awareness',
    targetAudience: '品牌潜在人群 / 核心消费群',
    cta: '了解更多',
  ...
  },
  {
    key: 'ad-product-demo',
    label: '产品卖点展示',
    desc: '适合功能演示、核心卖点分段讲解和电商详情导流。',
    tags: ['产品展示', '卖点讲解', '电商'],
    campaignType: 'product',
    objective: 'click',
    targetAudience: '有明确需求的搜索 / 比价用户',
    cta: '立即查看详情',
    durationPreference: '30s',
    styleTags: ['广告', '产品特写', '卖点展示', '电商'],
  ...
  },
  {
    ...
    label: '口播 / UGC 种草',
    desc: '适合用户证言、真人口播、种草安利和社媒原生广告。',
    tags: ['UGC', '口播', '种草'],
    campaignType: 'ugc',
    objective: 'engagement',
    targetAudience: '社媒活跃人群 / 内容兴趣用户',
    cta: '马上试试',
    durationPreference: '15s',
    styleTags: ['广告', '口播', '生活方式', '种草'],
