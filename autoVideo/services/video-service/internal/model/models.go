...
type VideoTask struct {
	...
	RequestedModel   string       `gorm:"type:varchar(128);default:''" json:"requested_model"`
	RoutedGenerator  string       `gorm:"type:varchar(128);default:''" json:"routed_generator"`
	RuntimeProvider  string       `gorm:"type:varchar(128);default:''" json:"runtime_provider"`
	EffectiveModel   string       `gorm:"type:varchar(128);default:''" json:"effective_model"`
	RouteReason      string       `gorm:"type:varchar(128);default:''" json:"route_reason"`
